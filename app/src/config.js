...
module.exports = {
    ...
    oidc: {
        ...
        */
        ...
        config: {
            ...
            baseURL: `http://localhost:${process.env.PORT ? process.env.PORT : 3010}`, // https://meeting.dev.qprofiles.com
            clientID: 'clientID',
    ...
    email: {
        ...
        */
        ...
        sendTo: 'chandra.parvam@gmail.com',
    },
    ngrok: {
        /* 
        Ngrok
        ...
        */
        brand: {
            ...
            og: {
                ...
                image: 'https://meeting.dev.qprofiles.com/images/mirotalksfu.png',
                url: 'https://meeting.dev.qprofiles.com',
            },
            html: {
                features: true,
